...
*
*   2011/04/07    Inserted comments on speed ragulations and support for ATtinyx4 (by Leonardo Miliani)
*
****************************************************************************/
...
//If you use the ATtiny85 at different clocks, you have to change this value to reflect
//your micro's speed in kHz. I.e.: for ATtiny85 at 8 MHz, SUS_CLK must be set to 8000.0
...
/*Like SYS_CLK, T2_TWI and T4_TWI have to be changed according to micro's speed
using the following formula: 5*clock_speed_in_MHz
I.e: for 8 MHz ATtiny T2_TWI must be set to 40 (5*8) and
T4_TWI must be set to 32 (4*8)*/
